...
def get_products(product_id):
    ...
    app.logger.info("Request to retrieve a product wuth id [%s]", product_id)
    product = Product.find(product_id)
    if not product:
        abort(status.HTTP_404_NOT_FOUND, "Product with id '{product_id}' was not found.")
...
def delete_products(product_id):
    """This endpoint deletes a product based in the product_id"""

    app.logger.info("Request to delete a prodcut with the id [%s]", product_id)
